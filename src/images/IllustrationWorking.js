...
const IllustrationWorking = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 733 482" {...props}>
      <defs>
        <linearGradient id="a" x1="0%" x2="100%" y1="50%" y2="50%">
          <stop offset="0%" stopColor="#183866"></stop>
          <stop offset="100%" stopColor="#1A7FC1"></stop>
        </linearGradient>
        <linearGradient id="b" x1="-.13%" x2="100%" y1="50.057%" y2="50.057%">
          <stop offset="0%"></stop>
          <stop offset="99%" stopOpacity="0"></stop>
        </linearGradient>
        <linearGradient
          id="c"
          x1="176.072%"
        ...
        >
          ...
          <stop offset="42%" stopColor="#EFD4D1"></stop>
          <stop offset="100%" stopColor="#F2EAC9"></stop>
        </linearGradient>
        <linearGradient
          id="r"
          x1="99.032%"
        ...
        <linearGradient
          ...
          y2="153.095%"
        >
          <stop offset="0%" stopColor="#362958" stopOpacity="0.501"></stop>
          <stop offset="100%" stopColor="#34313D" stopOpacity="0"></stop>
        </linearGradient>
        <linearGradient
          id="u"
          x1="3990.942%"
      ...
      <g fill="none">
        ...
        ></path>
        <circle cx="255" cy="395" r="11" fill="#25233A"></circle>
        <circle cx="253.5" cy="397.5" r="5.5" fill="#3F3D56"></circle>
        <circle cx="210" cy="384" r="11" fill="#25233A"></circle>
        <path
          fill="url(#a)"
          d="M214 384.5a5.5 5.5 0 11-11 0 5.5 5.5 0 0111 0z"
        ></path>
        <circle cx="207" cy="399" r="11" fill="#25233A"></circle>
        <path
          fill="#3F3D56"
        ...
        <path
          ...
          d="M87 396l-2.284 16.943-5.786 3.008c-24.648 7.42-50.415-1.038-50.415-1.038l-4.443-3.283L22 396h65z"
        ></path>
        <ellipse cx="54.5" cy="395" fill="#2BD0D0" rx="32.5" ry="6"></ellipse>
        <ellipse cx="54.5" cy="395" fill="url(#o)" rx="32.5" ry="6"></ellipse>
        <path
          fill="#2BD0D0"
...
export default IllustrationWorking;
